                ...
                <div class="p-0 p-md-3">
                    ...
                    <div class="d-flex justify-content-between align-items-center see-more-group">
                        <div class="d-flex align-items-center">
                            ...
                            @endif
                            <div class="ms-2 ">
                                <a href="{{route('baseOnUser',$article->user->id)}}" class="text-black-50 small text-decoration-none">
                                    <i class="feather-user"></i>
                                    {{$article->user->name}}
                                </a>
                                <br>
                                <a href="{{route('baseOnDate',$article->created_at)}}" class="text-black-50 text-decoration-none small">
