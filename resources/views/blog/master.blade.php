...
<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom position-fixed top-0 w-100">
    <div class="container">
        <a class="navbar-brand" href="{{route('index')}}">
            <img src="{{asset('image/logo.PNG')}}" style="height: 40px" class="me-1" alt="">
        </a>
                    ...
                    <div id="category">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item ">
                                <a href="{{route('baseOnCategory',$c->cat_slug)}}" class="{{request()->url() == route('baseOnCategory',$c->cat_slug) ?'active':''}}">{{$c->title}}</a>
                            </li>
                            @endforeach
                        </ul>
                    </div>
